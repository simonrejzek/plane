...
export const FeaturesTimeTrackingProjectSettingsHeader = observer(
  function FeaturesTimeTrackingProjectSettingsHeader() {
    // translation
    const { t } = useTranslation();
    // derived values
    const settingsDetails = PROJECT_SETTINGS.features_time_tracking;
    const Icon = PROJECT_SETTINGS_ICONS.features_time_tracking;
